// This script handles all client-side logic for the company-account.html page.

document.addEventListener('DOMContentLoaded', () => {
    // Get user data from local storage, redirect if not a logged-in company.
    ...
    // Fetches the company's current account details from the server and populates the form.
    async function fetchAccountDetails() {
        try {
            const response = await fetch(`/account-details?userId=${user.id}&role=company`);
